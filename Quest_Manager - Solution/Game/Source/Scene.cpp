...
bool Scene::Update(float dt)
{
	...
	{
		dialogue_mision = true;
		LOG("dialogue_mision = true");
	}
	...
	if (draw_DM)
	{
		app->render->DrawTexture(completed_mision, 1210, 60 + (8 * 64) + 2);
	}
	//-------------
